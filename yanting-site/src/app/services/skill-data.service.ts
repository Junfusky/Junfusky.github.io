...
export class SkillDataService {
  ...
  publications: publication[] = [
    {
      title: "Tailoring your AI friend: Effects of customization on users’ interaction with companion chatbots",
      authors: ["Jin Chen", "Yuan Sun", "Yanting Wu", "S Shyam Sundar"],
      publisher: " 71st Annual International Communication Association Conference",
  ...
  techSkills: Array<String> = ["JavaScript", "TypeScript", "SQL", "Node.js", "Angular", "HTML5", "CSS3", "jQuery", "Bootstrap", "Angular Material", "PrimeNG" ,"MySQL", "MongoDB", "GIT", "Agile (Scrum)", "Jasmine", "Karma", "Postman", "Python"] 

  uxSkills: Array<String> = ["Interview", "Heuristic evaluation", "Usability testing", "Competitor analysis", "Content analysis", "Think aloud", "Task analysis", "Figma", "Axure", "Adobe XD", "SPSS", "JMP"]
